...
<html lang="en" >
	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
		...
		<div class="m-grid m-grid--hor m-grid--root m-page">
			<div class="m-grid__item m-grid__item--fluid m-grid  m-error-2" style="background-image: url(/metronic/assets/app/media/img//error/bg2.jpg);">
				<div class="m-error_container">
					...
					<span class="m-error_desc m--font-light">
						La pági na que buscas parece que no existe <br>
						<a href="{{ route('inicio') }}">Regresar al sitio Web</a>
					</span>
				</div>
			</div>
		</div>
