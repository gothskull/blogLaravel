...
<html lang="en" >
	...
	<head>
		...
		<!--end::Base Styles -->
		{{-- MIS ESTILOS --}}
		<link href="/metronic/assets/app/styles.css" rel="stylesheet" type="text/css" />
...
<!-- begin::Footer -->
								...
								<div class="m-messenger__wrapper">
									<div class="m-messenger__message m-messenger__message--in">
										<div class="m-messenger__message-pic">
											<img src="/metronic/assets/app/media/img//users/user3.jpg" alt=""/>
										</div>
		...
		<!--end::Page Snippets -->
		{{-- VALIDACIÓN --}}
{{-- 		<script src="/metronic/assets/app/js/traslateValidation.js" type="text/javascript"></script>
 --}}
		@stack('scripts')
